    ...
    <div className="animate-fade-in" style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <div className="glass-card" style={{ padding: "24px" }}>
        <h2 style={{ fontSize: "24px", fontWeight: 800, color: "var(--text-primary)" }}>
          30-Day Project Build Sprints
        </h2>
        <p style={{ fontSize: "14px", color: "var(--text-muted)", marginTop: "4px" }}>
          4 Deployed, Portfolio-Ready Projects to showcase on your GitHub and resume.
        </p>
      </div>
      ...
      <div style={{ display: "grid", gap: "24px" }}>
        {projectsData.map((proj) => {
          ...
          return (
            <div key={proj.id} className="glass-card" style={{ padding: "24px" }}>
              {/* Top Details */}
              ...
              <div style={{ padding: "16px", borderRadius: "12px", background: "var(--bg-input)", border: "var(--glass-border)" }}>
                <h4 style={{ fontSize: "13px", fontWeight: 700, color: "var(--accent-indigo)", marginBottom: "10px" }}>
